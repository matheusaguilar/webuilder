export class WrapperUtil {
  ...
  public getImportTags(elem: any) {
     ...
     */
  private getImportChildren(children: []) {
    let tags: any = [];
  ...
  private isDescendant(parent: any, child: any) {
     ...
     * @param hideInner if false remove the wbuilder-inserd div and add
     * innerHTML of element to response.
     */
